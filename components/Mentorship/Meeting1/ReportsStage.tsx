                ...
                <div className="flex flex-col md:flex-row items-center gap-6">
                    ...
                    <div>
                        ...
                        <p className="text-slate-400">
                            Gere e imprima os relatórios detalhados de cada etapa da mentoria.
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-slate-900/50 border border-slate-800 p-6 rounded-2xl hover:border-emerald-500/30 transition-all group">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            <h4 className="font-bold text-white text-lg">Revisão de Orçamento</h4>
                            <p className="text-sm text-slate-500">Extrato, Entradas e Saídas</p>
                        </div>
                    </div>
                ...
                <div className="bg-slate-900/50 border border-slate-800 p-6 rounded-2xl hover:border-emerald-500/30 transition-all group">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            <h4 className="font-bold text-white text-lg">Gastos Não Recorrentes</h4>
                            <p className="text-sm text-slate-500">Mapeamento Anual e Reservas</p>
                        </div>
                    </div>
