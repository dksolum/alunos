...
interface ReportsStageM5Props {
    onPrintReview: () => void;
    onPrintExpenses: () => void;
    onPrintDebts: () => void;
    onPrintStatus: () => void;
    onPrintDreams: () => void;
    onPrintAssets: () => void; // New prop for M5
}

export const ReportsStageM5: React.FC<ReportsStageM5Props> = ({
    onPrintReview,
    onPrintExpenses,
    onPrintDebts,
    onPrintStatus,
        ...
        <div className="space-y-8 animate-fade-in">
            <div className="bg-slate-900/50 p-6 rounded-2xl border border-slate-800 text-center md:text-left">
                <div className="flex flex-col md:flex-row items-center gap-6">
                    ...
                    <div>
                        <h3 className="text-xl font-bold text-white mb-2">Relatórios e Impressão (M5)</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {/* Card Mapeamento de Patrimônio (NOVO M5) */}
