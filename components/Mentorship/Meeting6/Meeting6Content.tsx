                    ...
                    {activeStep === 7 && (
                        <TasksStage
                            ...
                            customTasks={[
                                ...
                                { id: 'm6_task5', label: 'Definir novo limite de gastos ou manter para o próximo mês - Enviar no grupo do WhatsApp' },
                                { id: 'm6_task6', label: 'Guardar o valor mensal previsto para os Gastos Não Recorrentes dentro da carteira definida' }
                            ]}
                        />
                    )}
                </div>
